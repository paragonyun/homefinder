...
- 기존 TMAP appKey 대중교통 API 권한 확장과 운영 조회 검증 완료
- 실제 NEIS 응답으로 학군 동기화 검증 완료
- 목적지 커스텀
- 지도 표시
...
- 로그인 없는 공개 접근 차단
- PC/모바일 주요 화면 확인
- 남은 운영 확인: 실제 통학구/중학군 배정 데이터 소스 검토
