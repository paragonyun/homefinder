...
- [x] 단지 상세에서 학군 정보 불러오기를 실행해 실제 NEIS 응답 저장 확인. 현재 학군 UI는 제외 상태입니다.
...
- [ ] 학군 기능을 다시 살릴 경우 실제 통학구/중학군 배정 데이터 또는 학교알리미 지표를 별도 공식 소스로 검토합니다.
